...
//        LOGGER.save("log.txt");
    ...
    public static void createAgentsPool()
    {
        if (!calledBefore)
        {
            ...
            calledBefore = true;
            //addAgentToThePool
//            AgentsPool.addAgent(new HybridAgent());
...
//            AgentsPool.addAgent(new SimpleMLPAgent());
 ...
 //            AgentsPool.addAgent(new LargeMLPAgent());
//             AgentsPool.addAgent(new LargeSRNAgent());
//             AgentsPool.addAgent(new ScaredSpeedyAgent());
//            AgentsPool.addAgent(new SRNAgent());
